  ...
  return (
    <div className="animate-fade-in">
      ...
      <Modal isOpen={!!jobToDelete} onClose={() => setJobToDelete(null)} title="Delete Job">
        <p style={{ marginBottom: '1.5rem' }}>Are you sure you want to delete <strong>{jobToDelete?.name}</strong>? This will permanently delete all input images, clusters, and reports associated with this job.</p>
        <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          {jobs.map(job => (
            <FolderCard
              ...
              onClick={() => { setSelectedJob(job); navigate('job-detail'); }}
